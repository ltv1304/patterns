...
from http_lib import TestRequest
...
class TestServer:
    ...
    def handle_connection(self, client_socket):
        ...
        if bytes:
            request = TestRequest(bytes)
            http_responce = app(request)

            client_socket.send(f'{http_responce.response_proto} {http_responce.response_status} {http_responce.response_status_text}'.encode())
